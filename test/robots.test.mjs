#!/usr/bin/env node
// test/robots.test.mjs - the public site must be crawlable.
//
// Search Console reported "Blocked by robots.txt" for pendpost.com. The repo
// shipped NO robots.txt, so a request for /robots.txt fell through serveStatic's
// SPA fallback and returned the dashboard HTML instead of a valid rules file.
//
...
console.log('[robots] OK - public site is crawlable; operational endpoints stay unindexed.');
process.exit(0);
