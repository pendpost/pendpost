...
export const STRINGS = {
  en: {
    ...
    // Spec 50 §S8: the "Respond for me" block. Every figure is a stored counter or a spec 44
    // evidence count - there is deliberately no follower, reach or engagement-rate line here.
    'digest.engage.header': '## Respond for me ({client}) · {mode}',
    'digest.engage.thisClient': 'this brand',
    'digest.engage.mode.dry_run': 'Dry run',
    'digest.engage.mode.live': 'Live',
    'digest.engage.mode.paused': 'Live · paused',
    'digest.engage.today': '- Today: {parts}',
    'digest.engage.kind.reply': 'replied',
    'digest.engage.kind.like': 'liked',
    'digest.engage.kind.follow': 'followed',
    'digest.engage.kind.repost': 'reposted',
    'digest.engage.kind.dm': 'messages',
    'digest.engage.needsYou': '- Needs you: {n} open{detail}',
    'digest.engage.needsYou.none': '- Needs you: nothing',
    'digest.engage.cooling': '- Cooling down: {lanes}',
    'digest.engage.cooling.none': '- Cooling down: none',
    'digest.engage.reason.platform_limit': 'platform limit',
    'digest.engage.reason.repeated_failure': 'several failed posts',
    'digest.engage.week': '- Last 7 days: {replies} replies, {answered} got an answer back',
    'digest.engage.noPush': '- No phone push is set up, so an urgent question waits until you open pendpost. Run `node scripts/telegram-social.mjs owner-chat --client <id>` to connect one.',
  ...
  'de-CH': {
    ...
    // Spec 50 §S8: der Block "Für mich antworten". Jede Zahl ist ein gespeicherter Zähler oder
    // ein Beleg aus Spec 44 - Follower, Reichweite und Interaktionsraten kommen hier nie vor.
    'digest.engage.header': '## Für mich antworten ({client}) · {mode}',
    'digest.engage.thisClient': 'diese Marke',
    'digest.engage.mode.dry_run': 'Probelauf',
    'digest.engage.mode.live': 'Aktiv',
    'digest.engage.mode.paused': 'Aktiv · pausiert',
    'digest.engage.today': '- Heute: {parts}',
    'digest.engage.kind.reply': 'geantwortet',
    'digest.engage.kind.like': 'geliked',
    'digest.engage.kind.follow': 'gefolgt',
    'digest.engage.kind.repost': 'geteilt',
    'digest.engage.kind.dm': 'Nachrichten',
    'digest.engage.needsYou': '- Braucht dich: {n} offen{detail}',
    'digest.engage.needsYou.none': '- Braucht dich: nichts',
    'digest.engage.cooling': '- Kühlt ab: {lanes}',
    'digest.engage.cooling.none': '- Kühlt ab: nichts',
    'digest.engage.reason.platform_limit': 'Plattform-Limit',
    'digest.engage.reason.repeated_failure': 'mehrere fehlgeschlagene Posts',
    'digest.engage.week': '- Letzte 7 Tage: {replies} Antworten, {answered} haben zurückgeschrieben',
    'digest.engage.noPush': '- Es ist kein Push aufs Handy eingerichtet, eine dringende Frage wartet also, bis du pendpost öffnest. Mit `node scripts/telegram-social.mjs owner-chat --client <id>` verbindest du einen.',
