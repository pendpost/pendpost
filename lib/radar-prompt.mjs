...
export function radarScanPrompt(queries, maxPerRun = AGENT_MAX_PER_RUN_DEFAULT, clientId = null, scanSources = null, geo = null, noteLocale = null, brand = null) {
...
Each signal in the signals array:
  ...
  - source: one of ${scope_sources.join(' | ')} - or "web" for anything else you found.
    ...
    shortcode from /p/<code>/ or /reel/<code>/.
