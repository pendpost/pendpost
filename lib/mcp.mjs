...
import {
  ...
  runRadarScan, listRadar, triageSignal, markCopyPosted, queueRadarReply, logRadarFootprint, radarIngest, radarFollowupCheck, radarFollowupReport,
...
const RADAR_CHILD_WRITE_TOOLS = new Set(['radar_ingest', 'radar_queue_reply', 'radar_footprint_log', 'radar_followup_report']);
