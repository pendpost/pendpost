...
export const PLAYBOOKS = {
    ...
    steps: [
      ...
      },
      {
        ...
        cli:
          ...
          '--page-id <ID> --app-id <ID> --app-secret <S> --client <client-id>',
    ...
    steps: [
      ...
      },
      {
        ...
        detail:
          ...
          'With "Share on LinkedIn" + "Sign In with LinkedIn" granted, the flow also captures your personal-profile URN automatically, ' +
          'unlocking the per-post "Personal profile" option in the composer (the default stays the Company Page).',
        cli: 'node scripts/linkedin-social.mjs auth --client <client-id>',
      },
    ],
    commonFailures: [
      {
      ...
      {
        symptom: 'A post set to publish on the personal profile is blocked ("member posting needs a captured person URN").',
        cause: 'The token was minted before member posting was set up, so no personal-profile URN was captured (w_member_social + Sign In with LinkedIn not both granted at auth time).',
        fix: 'Re-run the auth flow with "Share on LinkedIn" and "Sign In with LinkedIn" granted; the flow captures the person URN and the block clears.',
      },
      {
  ...
  x: {
    ...
    scopes: [
      ...
      // Kept in lockstep with SCOPES in scripts/x-social.mjs.
      'tweet.read',
      'tweet.write',
      'users.read',
      'media.write',
      'offline.access',
      // Inbound X Activity round-trip (spec 23): read the mentions/replies/likes/
      // follows/DMs the inbox surfaces, and dm.write to answer a direct message.
      'dm.read',
      'like.read',
      'follows.read',
      'dm.write',
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/x-social.mjs auth --client <client-id>',
        field: 'xHandle',
      },
    ],
    commonFailures: [
  ...
  youtube: {
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/yt-social.mjs auth --client <client-id>',
  ...
  telegram: {
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/telegram-social.mjs auth --client <client-id>',
      },
    ],
    commonFailures: [
      {
  ...
  discord: {
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/discord-social.mjs auth --client <client-id>',
      },
    ],
    commonFailures: [
      {
  ...
  reddit: {
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/reddit-social.mjs auth --client <client-id>',
      },
      {
  ...
  pinterest: {
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/pinterest-social.mjs auth --client <client-id>',
      },
    ],
    commonFailures: [
      {
  ...
  tiktok: {
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/tiktok-social.mjs auth --client <client-id>',
      },
      {
  ...
  mastodon: {
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/mastodon-social.mjs auth --client <client-id>',
      },
    ],
    commonFailures: [
      {
  ...
  wordpress: {
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/wordpress-social.mjs auth --client <client-id>',
      },
    ],
    commonFailures: [
      {
  ...
  ghost: {
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/ghost-social.mjs auth --client <client-id>',
      },
      {
  ...
  nostr: {
    ...
    steps: [
      ...
      },
      {
        ...
        cli: 'node scripts/nostr-social.mjs auth --client <client-id>',
      },
      {
  ...
  gbp: {
    ...
    steps: [
      ...
      },
      {
        ...
        env: 'GBP_CLIENT_ID, GBP_CLIENT_SECRET',
      },
      {
        title: 'Authorize',
        detail:
        ...
        cli: 'node scripts/gbp-social.mjs auth --client <client-id>',
      },
      {
        ...
        env: 'GBP_ACCOUNT_ID, GBP_LOCATION_ID',
      },
    ],
    commonFailures: [
      {
