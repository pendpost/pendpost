  ...
  youtube: {
    ...
    steps: [
      ...
      },
      {
        ...
        detail:
          'Configure the OAuth consent screen and add the scope https://www.googleapis.com/auth/youtube.force-ssl. ' +
    ...
    commonFailures: [
      ...
      },
      {
        ...
        cause: 'The OAuth consent screen is still in Testing mode, where refresh tokens expire in 7 days.',
        fix: 'Publish the consent screen (or keep re-authorizing); a Production app issues long-lived refresh tokens.',
      },
      {
