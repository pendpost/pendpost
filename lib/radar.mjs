...
// value now, so a bondigoo scan filters "bondigoo", never a hardcoded "pendpost" (the leak
// that emailed the bondigoo operator "pendpost vs Buffer"). It falls back to 'pendpost' only
...
// and "better than constructing" into to-write items for the bondigoo tenant. The declared
