...
// data/clients/<activeClientId>. With activeClientId=<client B>, a ceremony meant for
// pendpost silently targets client B's .env. The frozen `const ENV_PATH = envPath()`
...
// hand-run like `set-thumbnail --client <id>` SILENTLY IGNORED the flag and
