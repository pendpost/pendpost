...
import { loadManifest, loadPlanStore, postRev, postContentHash, POST_CONTENT_FIELDS, resolveMediaPath, postNeedsMedia } from './plans.mjs';
...
async function setApproval({ campaign, postId, actor, note, verdict }) {
  ...
  try {
    const result = await mutatePlan(found.absPlan, (plan) => {
      ...
      if (verdict === 'approved') post.approvedContentHash = postContentHash(post);
      else delete post.approvedContentHash;
      delete post.editedSinceApproval;
      return post;
    });
