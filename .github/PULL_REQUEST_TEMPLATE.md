...
- [ ] `npm run check` passes (syntax, parity, and the test suite).
- [ ] If I added or changed a write capability, it ships on BOTH faces (`/api` and `/mcp`) and the parity test still passes.
...
Describe what you ran. Mock mode is enough for most changes (`PENDPOST_MODE=mock`).
